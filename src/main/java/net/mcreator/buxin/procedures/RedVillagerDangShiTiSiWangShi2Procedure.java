...
public class RedVillagerDangShiTiSiWangShi2Procedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {

        BuxinMod.queueServerWork(11, () -> {
            if (world instanceof Level _level && !_level.isClientSide()) {
                ItemEntity entityToSpawn = new ItemEntity(_level, x, (y + 2), z, new ItemStack(BuxinModItems.RED_VILLAGER_HEAD_HELMET.get()));
                entityToSpawn.setPickUpDelay(10);
                entityToSpawn.setNeverPickUp();
                _level.addFreshEntity(entityToSpawn);
            }
            if (world instanceof Level _level && !_level.isClientSide()) {
                ItemEntity entityToSpawn = new ItemEntity(_level, x, (y + 2), z, new ItemStack(BuxinModItems.RED_VILLAGER_ARMOR_CHESTPLATE.get()));
                entityToSpawn.setPickUpDelay(10);
                entityToSpawn.setNeverPickUp();
                _level.addFreshEntity(entityToSpawn);
            }
