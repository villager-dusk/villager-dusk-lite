...
public class Niubi19XiongJiaShiJianMeiYouXiKeProcedure {
			...
			if (Math.random() < 0.5) {
				{
					...
					if (_entity instanceof Player _player) {
						_player.getInventory().armor.set(2, new ItemStack(BuxinModItems.BIGOBS_CHESTPLATE.get()));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
						_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(BuxinModItems.BIGOBS_CHESTPLATE.get()));
					}
				}
				...
				}
				{
					...
					for (Entity entityiterator : _entfound) {
						if (!(entityiterator instanceof Player)) {
							entityiterator.hurt(new DamageSources(world.registryAccess()).generic(), 7);
						}
					}
				}
			...
			BuxinMod.queueServerWork(20, () -> {
				{
					Entity _entity = entity;
					if (_entity instanceof Player _player) {
						_player.getInventory().armor.set(2, new ItemStack(BuxinModItems.NIUBI_19_CHESTPLATE.get()));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
						_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(BuxinModItems.NIUBI_19_CHESTPLATE.get()));
					}
				}
			});
		}
		if (entity instanceof Player _player)
			_player.getCooldowns().addCooldown(BuxinModItems.BIGOBS_CHESTPLATE.get(), 100);
		if (entity instanceof Player _player)
			_player.getCooldowns().addCooldown(BuxinModItems.NIUBI_19_CHESTPLATE.get(), 100);
	}
}
