...
public class ZanZhu9Entity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public ZanZhu9Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.ZAN_ZHU_9.get(), world);
	}

	public ZanZhu9Entity(EntityType<ZanZhu9Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("twz"));
		setCustomNameVisible(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.ZSZR_JUE_XING.get()));
