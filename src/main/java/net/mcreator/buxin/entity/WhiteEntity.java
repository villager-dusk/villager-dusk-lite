...
public class WhiteEntity extends Monster {
	public WhiteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.WHITE.get(), world);
	}

	public WhiteEntity(EntityType<WhiteEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.HEROBRINE_DIAMOND_SWORD.get()));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(BuxinModItems.PINK_DIAMOND_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(BuxinModItems.PINK_DIAMOND_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(BuxinModItems.PINK_DIAMOND_LEGGINGS.get()));
	...
	public static void init() {
		//DungeonHooks.addDungeonMob(BuxinModEntities.WHITE.get(), 180);
	}
