...
import net.mcreator.buxin.procedures.ZanZhu2DangShiTiSiWangShiProcedure;
...
public class ZanZhu2Entity extends Monster {
    private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

    public ZanZhu2Entity(EntityType<ZanZhu2Entity> type, Level world) {
        super(type, world);
        maxUpStep = 0.6f;
        xpReward = 0;
        setNoAi(false);
        setCustomName(Component.literal("不出胡桃不改名"));
    ...
    public void die(DamageSource source) {
        super.die(source);
        ZanZhu2DangShiTiSiWangShiProcedure.execute(this.level);
    }
