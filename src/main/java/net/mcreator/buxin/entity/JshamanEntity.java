...
import net.mcreator.buxin.procedures.PlayermobsDeadProcedure;
...
public class JshamanEntity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public JshamanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.JSHAMAN.get(), world);
	}

	public JshamanEntity(EntityType<JshamanEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.NIUBI.get()));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		PlayermobsDeadProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
