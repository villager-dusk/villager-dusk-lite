...
import net.mcreator.buxin.procedures.RunGraveShiTiChuShiShengChengShiProcedure;
...
public class RunGraveEntity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public RunGraveEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.RUN_GRAVE.get(), world);
	}

	public RunGraveEntity(EntityType<RunGraveEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.ZUAN_SHI_DAO_PIAN.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(BuxinModItems.ZUAN_SHI_DAO.get()));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(BuxinModItems.CUN_MIN_TOU_TAO_HELMET.get()));
	...
	public boolean hurt(DamageSource source, float amount) {
		...
		if (source.is(DamageTypes.LIGHTNING_BOLT))
			return false;
		if (source.is(DamageTypes.EXPLOSION) || source.is(DamageTypes.PLAYER_EXPLOSION) || source.is(DamageTypes.BAD_RESPAWN_POINT))
			return false;
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		RunGraveShiTiChuShiShengChengShiProcedure.execute(world, this);
		return retval;
	}
