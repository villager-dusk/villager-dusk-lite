...
import net.mcreator.buxin.procedures.HerobrineDangShiTiGengXinKeShiProcedure;
import net.mcreator.buxin.procedures.HerobrineShiTiChuShiShengChengShiProcedure;
...
public class HerobrineEntity extends Monster {
	...
	public HerobrineEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.HEROBRINE.get(), world);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		HerobrineShiTiChuShiShengChengShiProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		this.setItemSlot(EquipmentSlot.MAINHAND, Items.OBSIDIAN.getDefaultInstance());
		this.setItemSlot(EquipmentSlot.OFFHAND, Items.OBSIDIAN.getDefaultInstance());
		return retval;
	}
