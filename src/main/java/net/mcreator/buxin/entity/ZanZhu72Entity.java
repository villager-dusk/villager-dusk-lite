...
public class ZanZhu72Entity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public ZanZhu72Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.ZAN_ZHU_72.get(), world);
	}

	public ZanZhu72Entity(EntityType<ZanZhu72Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("XiaoChouSec"));
