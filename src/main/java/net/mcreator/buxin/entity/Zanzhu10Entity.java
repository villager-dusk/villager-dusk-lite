...
public class Zanzhu10Entity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public Zanzhu10Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.ZANZHU_10.get(), world);
	}

	public Zanzhu10Entity(EntityType<Zanzhu10Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		setCustomNameVisible(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.LEGENDARY_SWORD.get()));
