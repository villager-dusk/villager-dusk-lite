...
package net.mcreator.buxin.entity.fishinghook;
...
public class FishingHook extends Projectile {
    ...
    public FishingHook(Entity p_37106_, Level p_37107_) {
        this(BuxinModEntities.FISHING_HOOK.get(), p_37107_);
    ...
    public void addAdditionalSaveData(CompoundTag p_37161_) {
        super.addAdditionalSaveData(p_37161_);
    }

    public void readAdditionalSaveData(CompoundTag p_37151_) {
        super.readAdditionalSaveData(p_37151_);
    }
    ...
    public void handleEntityEvent(byte p_37123_) {
        if (p_37123_ == 31 && this.level().isClientSide && this.hookedIn instanceof LivingEntity) {
            this.pullEntity(this.hookedIn);
        }
    ...
    protected void pullEntity(Entity entity) {
        ...
        if (owner != null) {
            Vec3 vec3 = (new Vec3(owner.getX() - this.getX(), Math.max(owner.getY() - this.getY(), 1d), owner.getZ() - this.getZ())).scale(0.35D);
