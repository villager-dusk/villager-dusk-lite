...
import net.mcreator.buxin.procedures.Jshaman2DangShiTiSiWangShiProcedure;
...
public class Jshaman2Entity extends Monster {
	public Jshaman2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.JSHAMAN_2.get(), world);
	}

	public Jshaman2Entity(EntityType<Jshaman2Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		Jshaman2DangShiTiSiWangShiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public static void init() {
		SpawnPlacements.register(BuxinModEntities.JSHAMAN_2.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
