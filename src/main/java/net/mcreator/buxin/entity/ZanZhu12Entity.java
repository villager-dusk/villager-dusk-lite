...
public class ZanZhu12Entity extends Monster {
    private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

    public ZanZhu12Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(BuxinModEntities.ZAN_ZHU_12.get(), world);
    }

    public ZanZhu12Entity(EntityType<ZanZhu12Entity> type, Level world) {
        super(type, world);
        maxUpStep = 0.6f;
        xpReward = 0;
        setNoAi(false);
        setCustomName(Component.literal("就没事了"));
        setCustomNameVisible(false);
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.SHEREN.get()));
