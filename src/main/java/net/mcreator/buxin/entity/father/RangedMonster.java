...
public class RangedMonster extends Monster implements RangedAttackMob {
    protected RangedMonster(EntityType<? extends Monster> p_21683_, Level p_21684_) {
    ...
    public void performRangedAttack(LivingEntity pTarget, float pVelocity) {
        ...
        if(Math.random() > 0.3){
            ...
            if(Math.random() < 0.5 && !this.level().isRainingAt(pTarget.blockPosition())){
