...
public class RangedMob extends Mob implements RangedAttackMob {
    protected RangedMob(EntityType<? extends Mob> p_21683_, Level p_21684_) {
    ...
    public void performRangedAttack(LivingEntity pTarget, float pVelocity) {
        ...
        java.util.Optional<InteractionHand> handOpt = java.util.Optional.of(ProjectileUtil.getWeaponHoldingHand(this, this::canFireProjectileWeapon));
        ItemStack weaponStack = handOpt.map(this::getItemInHand).orElse(ItemStack.EMPTY);
