...
import net.mcreator.buxin.procedures.FengSuiTaErQuDangShiTiGengXinKeShiProcedure;
...
public class FengSuiTaErQuEntity extends Monster {
    private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

    public FengSuiTaErQuEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(BuxinModEntities.FENG_SUI_TA_ER_QU.get(), world);
    }

    public FengSuiTaErQuEntity(EntityType<FengSuiTaErQuEntity> type, Level world) {
        super(type, world);
        maxUpStep = 0.6f;
        xpReward = 0;
        setNoAi(false);
    ...
    public void baseTick() {
        super.baseTick();
        FengSuiTaErQuDangShiTiGengXinKeShiProcedure.execute(this);
    }
