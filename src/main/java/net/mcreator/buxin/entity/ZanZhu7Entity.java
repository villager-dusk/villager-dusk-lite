...
public class ZanZhu7Entity extends Monster {
    private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

    public ZanZhu7Entity(PlayMessages.SpawnEntity packet, Level world) {
        this(BuxinModEntities.ZAN_ZHU_7.get(), world);
    }

    public ZanZhu7Entity(EntityType<ZanZhu7Entity> type, Level world) {
        super(type, world);
        maxUpStep = 0.6f;
        xpReward = 0;
        setNoAi(false);
        setCustomName(Component.literal("ddup"));
    ...
    public static void init() {
        DungeonHooks.addDungeonMob(BuxinModEntities.ZAN_ZHU_7.get(), 180);
    }

    public static AttributeSupplier.Builder createAttributes() {
        AttributeSupplier.Builder builder = Mob.createMobAttributes();
        builder = builder.add(Attributes.MOVEMENT_SPEED, 0.3);
        builder = builder.add(Attributes.MAX_HEALTH, 609);
