...
public class ZanZhu4Entity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public ZanZhu4Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.ZAN_ZHU_4.get(), world);
	}

	public ZanZhu4Entity(EntityType<ZanZhu4Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("清新的胡桃"));
		setCustomNameVisible(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.XINGJIZR.get()));
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		SoundEvent sound = ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.player.big_fall"));
		if (sound != null) {
			this.playSound(sound, 0.15f, 1);
		}
	}
