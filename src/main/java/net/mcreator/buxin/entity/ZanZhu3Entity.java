...
public class ZanZhu3Entity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public ZanZhu3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.ZAN_ZHU_3.get(), world);
	}

	public ZanZhu3Entity(EntityType<ZanZhu3Entity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("Minecraft_chunshui"));
