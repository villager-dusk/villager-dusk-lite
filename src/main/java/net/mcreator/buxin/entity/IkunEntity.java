...
public class IkunEntity extends Monster {
    public IkunEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(BuxinModEntities.IKUN.get(), world);
    }

    public IkunEntity(EntityType<IkunEntity> type, Level world) {
        super(type, world);
        maxUpStep = 0.6f;
        xpReward = 0;
        setNoAi(false);
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(BuxinModItems.FIRE_SNAKE_SWORD.get()));
    }
    ...
    public static void init() {
        //DungeonHooks.addDungeonMob(BuxinModEntities.IKUN.get(), 180);
    }
