...
public class DengZiEntity extends Monster {
	public DengZiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BuxinModEntities.DENG_ZI.get(), world);
	}

	public DengZiEntity(EntityType<DengZiEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
