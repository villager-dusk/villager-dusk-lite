...
public abstract class PurpleVillagerItem extends ArmorItem {
	public PurpleVillagerItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends PurpleVillagerItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "buxin:textures/models/armor/purple__layer_1.png";
		}
	}

	public static class Chestplate extends PurpleVillagerItem {
		public Chestplate() {
	...
	public static class Leggings extends PurpleVillagerItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "buxin:textures/models/armor/purple__layer_2.png";
		}
	}

	public static class Boots extends PurpleVillagerItem {
		public Boots() {
