...
public class NullAxeItem extends AxeItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionhand) {
        ...
        NullAxeEntity sword = BuxinModEntities.NULL_AXE.get().create(server);
        if (sword == null) {
        ...
        // 在MC1.20.1中，finalizeSpawn方法的第二个参数类型已从DifficultyInstance改为Difficulty（枚举）
        // server.getCurrentDifficultyAt()返回的正是Difficulty，此处直接使用
