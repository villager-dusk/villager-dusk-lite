...
public class NullShovelItem extends ShovelItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionhand) {
        ...
        if (player.getPersistentData().contains("NullShovelUUID")) {
            return InteractionResultHolder.pass(stack);
        }
        ...
        NullShovelEntity sword = BuxinModEntities.NULL_SHOVEL.get().create(server);
        if (sword == null) {
        ...
        player.getPersistentData().putUUID("NullShovelUUID", sword.getUUID());
