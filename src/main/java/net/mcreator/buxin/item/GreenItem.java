...
public abstract class GreenItem extends ArmorItem {
    public GreenItem(EquipmentSlot slot, Item.Properties properties) {
    ...
    public static class Chestplate extends GreenItem {
        public Chestplate() {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "buxin:textures/models/armor/gknight_layer_1.png";
        }
    }
}
