...
public class ModelPrisoner<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("buxin", "model_prisoner"), "main");
    ...
    public ModelPrisoner(ModelPart root) {
