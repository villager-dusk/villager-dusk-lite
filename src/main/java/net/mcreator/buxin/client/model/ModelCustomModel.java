...
public class ModelCustomModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("buxin", "model_custom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = hei_yao_shi.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(25, 9).addBox(0.2F, -12.0F, -23.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(25, 9).addBox(-0.8F, -12.0F, -23.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(25, 9)
						.addBox(0.0F, -11.0F, -23.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(25, 9).addBox(-1.0F, -11.0F, -23.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8745F, 0.0561F, -0.0669F));
		PartDefinition cube_r2 = hei_yao_shi.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(25, 9).addBox(3.2F, -12.0F, 13.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6963F, 0.0561F, -0.0669F));
		...
		PartDefinition cube_r4 = hei_yao_shi.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(25, 9).addBox(6.0F, -14.0F, -16.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 2.661F, -0.4207F, -2.9783F));
		PartDefinition cube_r5 = hei_yao_shi.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(25, 9).addBox(9.0F, -14.0F, -12.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.3911F, 0.6784F, -1.2891F));
		PartDefinition cube_r6 = hei_yao_shi.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(25, 9).addBox(2.0F, -11.0F, -22.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
