...
public class ModelGrave_head<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("buxin", "model_grave_head"), "main");
	...
	public ModelGrave_head(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(3.0F, -3.5F, -4.1F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.48F));
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -4.0F, -4.1F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
		PartDefinition bone = Head.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(1, 1).addBox(-2.0F, -0.87F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 1).addBox(-2.0F, -0.89F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 1)
						.addBox(-2.0F, -0.91F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 1).addBox(-2.0F, -0.93F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 1)
						.addBox(-2.0F, -0.95F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 1).addBox(-2.0F, -0.96F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 1)
						.addBox(-2.0F, -0.97F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 1).addBox(-2.0F, -1.0F, -5.12F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
