...
public class Model格雷夫双剑胸甲<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("buxin", "model_ge_lei_fu_shuang_jian_xiong_jia"), "main");
	...
	public Model格雷夫双剑胸甲(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone3 = Body.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 55).addBox(0.0F, -19.0F, 5.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
				.addBox(-1.0F, -20.0F, 5.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 55).addBox(-2.0F, -19.0F, 5.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
