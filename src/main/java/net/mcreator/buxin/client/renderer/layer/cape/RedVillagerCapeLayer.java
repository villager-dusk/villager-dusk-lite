...
public class RedVillagerCapeLayer extends RenderLayer<RedVillagerEntity, PlayerModel<RedVillagerEntity>> {
    public RedVillagerCapeLayer(RenderLayerParent<RedVillagerEntity, PlayerModel<RedVillagerEntity>> playerModelIn) {
        super(playerModelIn);
    }

    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, RedVillagerEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
