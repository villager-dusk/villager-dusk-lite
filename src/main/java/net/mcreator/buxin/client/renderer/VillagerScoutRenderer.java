...
public class VillagerScoutRenderer extends RangedAttackMobRenderer<VillagerScoutEntity, PlayerModel<VillagerScoutEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(VillagerScoutEntity entity) {
