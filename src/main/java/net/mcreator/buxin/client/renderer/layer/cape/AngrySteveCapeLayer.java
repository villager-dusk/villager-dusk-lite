...
public class AngrySteveCapeLayer extends RenderLayer<Niubi14Entity, PlayerModel<Niubi14Entity>> {
    public AngrySteveCapeLayer(RenderLayerParent<Niubi14Entity, PlayerModel<Niubi14Entity>> playerModelIn) {
        super(playerModelIn);
    }

    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, Niubi14Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        Optional<ResourceLocation> location = Optional.of(new ResourceLocation("buxin:textures/capes/qyzpc.png"));
