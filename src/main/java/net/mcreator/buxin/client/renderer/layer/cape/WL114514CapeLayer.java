...
import net.mcreator.buxin.entity.WL114514Entity;
...
public class WL114514CapeLayer extends RenderLayer<WL114514Entity, PlayerModel<WL114514Entity>> {
    public WL114514CapeLayer(RenderLayerParent<WL114514Entity, PlayerModel<WL114514Entity>> playerModelIn) {
        super(playerModelIn);
    }

    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, WL114514Entity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        Optional<ResourceLocation> location = Optional.of(new ResourceLocation("buxin:textures/capes/tiktok.png"));
