...
public class NotchCapeLayer extends RenderLayer<NotchEntity, PlayerModel<NotchEntity>> {
    public NotchCapeLayer(RenderLayerParent<NotchEntity, PlayerModel<NotchEntity>> playerModelIn) {
        super(playerModelIn);
    }

    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, NotchEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        Optional<ResourceLocation> location = Optional.of(new ResourceLocation("buxin:textures/capes/mojangpf.png"));
