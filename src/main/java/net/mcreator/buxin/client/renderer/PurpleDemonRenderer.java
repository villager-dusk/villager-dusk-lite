...
public class PurpleDemonRenderer extends HumanoidMobRenderer<PurpleDemonEntity, PlayerModel<PurpleDemonEntity>> {

    public PurpleDemonRenderer(EntityRendererProvider.Context context) {
    ...
    @Override
    public ResourceLocation getTextureLocation(PurpleDemonEntity entity) {
        return new ResourceLocation("buxin:textures/entities/purple_demon.png");
    }

    @Override
    protected void setupRotations(PurpleDemonEntity p_114109_, PoseStack p_114110_, float p_114111_, float p_114112_, float p_114113_) {
