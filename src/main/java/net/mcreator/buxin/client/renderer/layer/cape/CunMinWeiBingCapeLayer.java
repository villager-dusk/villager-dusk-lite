...
public class CunMinWeiBingCapeLayer extends RenderLayer<CunMinWeiBingEntity, PlayerModel<CunMinWeiBingEntity>> {
    public CunMinWeiBingCapeLayer(RenderLayerParent<CunMinWeiBingEntity, PlayerModel<CunMinWeiBingEntity>> playerModelIn) {
        super(playerModelIn);
    }

    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, CunMinWeiBingEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
