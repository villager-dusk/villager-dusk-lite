package net.mcreator.buxin.client.renderer.layer.cape;
...
import net.mcreator.buxin.entity.PurpleVillagerCavalryEntity;
import net.mcreator.buxin.entity.PurpleVillagerCavalryEntity;
...
public class PurpleVillagerCavalryCapeLayer extends RenderLayer<PurpleVillagerCavalryEntity, PlayerModel<PurpleVillagerCavalryEntity>> {
    public PurpleVillagerCavalryCapeLayer(RenderLayerParent<PurpleVillagerCavalryEntity, PlayerModel<PurpleVillagerCavalryEntity>> playerModelIn) {
        super(playerModelIn);
    }

    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, PurpleVillagerCavalryEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        Optional<ResourceLocation> location = Optional.of(new ResourceLocation("buxin:textures/capes/cmpf.png"));
        if (!entity.isInvisible() && RenderCapeConfig.RenderCape.get()) {
